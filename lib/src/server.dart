...
class TransportServer {
  /// Constructor
  /// Cannot extends it
  factory TransportServer(
          {int localPort, bool isLocal, ServerTransaction transaction}) =>
      TransportServer._(
          localPort: localPort,
  ...
  TransportServer._(
      {this.localPort, this.isLocal, ServerTransaction transaction})
  ...
  Future<void> startServer() async {
    ...
    _serverSocket =
        await ServerSocket.bind(isLocal ? '127.0.0.1' : '0.0.0.0', localPort);
...
abstract class ServerTransaction {
  ServerTransaction({LogInterface logInterface}) : _logInterface = logInterface;
